...
public class InvoiceItemViewModel {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && invoiceId == that.invoiceId && quantity == that.quantity && Objects.equals(item, that.item) && Objects.equals(unitRate, that.unitRate) && Objects.equals(discount, that.discount);
    }
